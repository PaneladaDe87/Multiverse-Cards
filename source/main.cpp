...
void card() {
    ...
    Card Card4("Arrows", 100, 0, "Area", "./assets/card4.png", 3, "Spell", false, 1.25f, 5, false, false, 0, 0, 0, 5);
    ...
    Card Card19("Combat Helicopter", 90, 330, "Distance", "./assets/card19.png", 4, false, 1.25f, 1, true, false, 0, 0, 0, 4);
    Card Card20("Trojan Horse", 96, 300, "Charge", "./assets/card20.png", 4 true, 0.3f, 1, false, false, 0, 222, 0, 1.25f);
    ...
    Card Card23("Tsunami", 100, 0, "Area", "./assets/card23.png", 5, false, 1.5f, 1, false, false, 0, 0, 0, 2);
    ...
    Card Card28("Astronaut", 99, 333, "Distance", 0);
}
